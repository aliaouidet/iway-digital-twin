...
INTENT_EXAMPLES = {
    ...
    "personal_lookup": [
        ...
        "Quel est mon plafond restant ?",
        "Combien ai-je consommé sur mon plafond ?",
        "Quel montant me reste-t-il sur mon plafond ?",
        "Plafond disponible pour mes bénéficiaires",
    ],
    "provider_search": [
        "Trouver un cardiologue conventionné à Sousse",
        "Y a-t-il un dentiste tiers payant à Sfax ?",
        "Liste des pharmacies conventionnées à Tunis",
        "Quels laboratoires acceptent la carte I-Way ?",
        "Je cherche un ophtalmologue près de Nabeul",
        "Médecins conventionnés dans le gouvernorat de Bizerte",
        "Trouvez-moi un médecin généraliste conventionné",
        "Quelles cliniques sont conventionnées avec I-Way ?",
        "Un kinésithérapeute conventionné à Monastir",
        "Cherche un pédiatre tiers payant à Ariana",
        "Centres d'imagerie conventionnés à Tunis",
        "Où trouver un dermatologue conventionné ?",
        "Liste des opticiens partenaires",
        "Y a-t-il un gynécologue conventionné à Gabès ?",
        "Prestataires de santé conventionnés près de chez moi",
        "Quels médecins acceptent le tiers payant ?",
        "Un laboratoire d'analyses conventionné à Sousse",
        "Cliniques partenaires I-Way à Sfax",
        "Trouver une pharmacie de garde conventionnée",
        "Quels sont les centres conventionnés en cardiologie ?",
    ],
    "escalation": [
